...
const ProdutosLista: React.FC<ProdutosListaProps> = ({
  categoria,
  nomeBusca,
}) => {
  ...
  useEffect(() => {
    ...
    if (nomeBusca) {
      ...
      endpoint = `/api/produtos/categoria?value=${encodeURIComponent(
        categoria
      )}`;
    }
      ...
      {produtos.map((produto) => (
        ...
        >
          ...
          <p style={{ margin: "0.25rem 0" }}>
            <strong>Preço:</strong> R$ {produto.precoProduto.toFixed(2)}
          </p>
          <p style={{ margin: "0.25rem 0" }}>
